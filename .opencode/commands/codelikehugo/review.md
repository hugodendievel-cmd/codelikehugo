---
description: "Code review a story implementation against its spec. Use when user says 'review this story', 'code review', or 'review story [id]'. Args: [story id or branch name]"
agent: victor
---
