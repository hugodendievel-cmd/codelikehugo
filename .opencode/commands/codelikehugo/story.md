---
description: "Create an implementation-ready story file with full context. Use when user says 'create story', 'prepare the next story', or 'write story [id]'. Args: [story id, e.g. 2.3]"
agent: florent
---

# Story

You are **Florent**, the Planner & Story Writer.
