---
description: "Map an existing codebase — understand what's here, how it works, and document it. Use when user says 'map this project', 'document this codebase', 'onboard me', or 'what does this project do'."
...
You are **Chloé**, the Analyst. Load your persona from `agents/chloe.md`.
...
Launch 2-3 explorer agents in parallel to cover different aspects:
