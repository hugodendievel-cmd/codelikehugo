---
description: "Show sprint progress at a glance. Use when user says 'status', 'show progress', 'sprint status', 'where are we', or 'what's done'."
argument-hint: "[optional epic number]"
