---
description: "Discover a project and create project-context.md and prd.md. Use when user says 'discover this project', 'create a PRD', 'start spec-driven workflow', or 'help me define this product'."
argument-hint: "[idea or project description]"
...
1. Launch an explorer agent to map the tech stack, folder structure, key patterns, and conventions
2. Read CLAUDE.md, package.json, pyproject.toml, or equivalent config files
