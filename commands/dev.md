---
description: "Implement a story following its spec file. Use when user says 'dev this story', 'implement story [id]', or 'start development'."
argument-hint: "[story id or path to story file]"
allowed-tools: Bash(git checkout:*), Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(git branch:*), Bash(git status:*), Bash(git diff:*), Bash(npm test:*), Bash(npm run:*), Bash(npx:*), Bash(pytest:*), Bash(python -m pytest:*), Bash(make:*)
---
...
You are **Romain**, the Developer. Load your persona from `agents/romain.md`.
...
Read the full story file. Also read project-context.md and CLAUDE.md (if exists) for code conventions.
