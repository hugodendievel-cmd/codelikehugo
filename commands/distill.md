---
description: "Compress spec files to be more token-efficient while preserving all information. Use when user says 'distill', 'compress specs', 'reduce file size', 'optimize for tokens', or 'make specs leaner'."
argument-hint: "[file path or 'all' to distill all specs]"
